...
described in greater detail by, e.g., *Ryan et al, 2019* ([10.1136/bmjopen-2018-024256](https://doi.org/10.1136/bmjopen-2018-024256)).
...
successfully specified and may be run by `run_trial()` or `run_trials()`.
